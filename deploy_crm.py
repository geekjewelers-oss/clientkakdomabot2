        ...
        "fields": [
            {"field": "address", "type": "string"},
            {
                ...
                "meta": {
                    "options": {
                        "choices": [
                            {"text": "Свободна", "value": "free"},
                            {"text": "Занята", "value": "occupied"},
                        ]
                    }
                },
            },
    ...
    "passports": {
        ...
        "fields": [
            ...
            # Флаги контроля OCR:
            {
                ...
                "type": "boolean",
                "meta": {
                    "note": "Авто-флаг: если OCR < 90%, требуется проверка менеджера"
                },
            },
            {
                "field": "manager_approved",
                "type": "boolean",
                "meta": {"note": "Ручное подтверждение паспорта менеджером"},
            },
        ],
    },
    "deals": {
        ...
        "fields": [
            ...
            # === ФЛАГИ КОНТРОЛЯ МЕНЕДЖЕРА (Блокираторы стадий) ===
            {
                ...
                "type": "boolean",
                "meta": {"note": "Менеджер проверил паспорт"},
            },
            {
                "field": "check_registration_allowed",
                "type": "boolean",
                "meta": {"note": "Менеджер одобрил регистрацию"},
            },
            {
                "field": "check_contract_signed",
                "type": "boolean",
                "meta": {"note": "Договор подписан обеими сторонами"},
            },
            {
                "field": "check_payment_received",
                "type": "boolean",
...
def _validate_settings() -> None:
    ...
    if not ADMIN_TOKEN:
        missing_vars.append("ADMIN_TOKEN")
